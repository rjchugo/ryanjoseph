	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == submit) {
			...
			try {
				...
				pw.println("Name: " + setGet.getName());
				pw.println("Password: " + setGet.getPassword());
				pw.println("Confirm-Password: " + setGet.getConPass());
				pw.println("City: " + setGet.getCities());
				pw.println("Gender: " + setGet.getGender());
				pw.println("Gmail: " + setGet.getGmail());
